    ...
    <div className="group relative flex flex-col bg-gradient-to-b from-slate-900/60 to-slate-900/40 border border-white/[0.06] rounded-3xl overflow-hidden hover:border-blue-500/30 transition-all duration-500 shadow-2xl h-full">
      ...
      <div className="p-5 md:p-8 flex flex-col flex-grow relative">
        ...
        <div className="flex justify-between items-start mb-3 md:mb-4 gap-3 shrink-0">
          <h3 className="text-base md:text-xl font-bold text-white tracking-tight">{commission.title}</h3>
          <div className="shrink-0 px-2.5 py-1 bg-blue-600/10 border border-blue-500/20 rounded-lg">
            <span className="text-blue-400 font-black text-xs md:text-sm tracking-wide">${commission.price}</span>
          </div>
        </div>
        <div className="flex-grow">
          <p className="text-slate-400 text-xs md:text-sm leading-relaxed whitespace-pre-wrap break-words">
