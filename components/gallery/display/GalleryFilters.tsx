  ...
  return (
    <>
      <div className="mb-6 md:mb-16">
        ...
        <div className="flex items-center gap-3 mt-3 md:mt-5 overflow-x-auto gallery-scrollbar pb-2">
          {isAdmin && (
            <button
              onClick={onOpenManager}
              className="w-7 h-7 md:w-10 md:h-10 flex items-center justify-center rounded-xl bg-white/5 hover:bg-blue-600 hover:text-white transition-all cursor-pointer text-slate-500 shrink-0 group"
            >
