...
export default function AvatarCropModal({ imageSrc, onConfirm, onCancel }: AvatarCropModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[600] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg max-h-[92dvh] bg-slate-900 border border-white/[0.06] rounded-2xl shadow-2xl animate-in zoom-in-95 duration-200 flex flex-col overflow-hidden">
        ...
        <div className="p-4 sm:p-5 flex-1 min-h-0 overflow-auto flex items-center justify-center bg-slate-950/50">
          <ReactCrop
            crop={crop}
          ...
          >
            <img
              ...
              alt="Crop preview"
              onLoad={onImageLoad}
              className="max-h-[min(56dvh,500px)] max-w-full object-contain"
            />
          </ReactCrop>
        </div>

        <div className="shrink-0 border-t border-white/[0.05] bg-slate-900/95 backdrop-blur-sm">
          <p className="text-center text-[9px] text-slate-600 font-bold uppercase tracking-widest pt-3 pb-2 px-4">
